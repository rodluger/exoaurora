...
In order to reproduce the HARPS search figures from the paper, you'll have to download the HARPS data. These are all publicly accessible at [the ESO Archive](http://archive.eso.org/wdb/wdb/adp/phase3_main/form). Direct links to the spectra we used are
...
These scripts also plot the orbital line broadening figure. Simply run
